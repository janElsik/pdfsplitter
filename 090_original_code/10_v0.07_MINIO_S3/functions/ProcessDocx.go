...
func ProcessDocx(w http.ResponseWriter, r *http.Request, directoryPath string, splitToXPages int, dirName string) (tempFile string) {
	...
	cmd := exec.Command("doc2pdf", TempFile.Name())
